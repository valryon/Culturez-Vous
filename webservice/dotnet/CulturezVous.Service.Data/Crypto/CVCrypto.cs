...
namespace CulturezVous.Service.Data.Crypto
{
    /// <summary>
    /// Crypto AES 128 avec Padding PKCS7 et IV décrite par "cryptoKey"
    /// </summary>
    public static class CVCrypto
    {
        /// <summary>
        /// Clé partagée avec les applications mobiles
        /// </summary>
        private static string cryptoKey = "PotPiwisi"; // 16 octets MAX
